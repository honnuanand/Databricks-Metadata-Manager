...
CREATE SCHEMA IF NOT EXISTS arao.metadata_test
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.users (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.products (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.orders (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.order_items (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.employees (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.customer_segments (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.daily_sales_summary (
...
CREATE TABLE IF NOT EXISTS arao.metadata_test.revenue_by_product (
